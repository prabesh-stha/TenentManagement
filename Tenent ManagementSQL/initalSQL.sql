...
BEGIN
	...
	IF @FLAG = 'L'
		BEGIN
		    SELECT A.ID ID, U.ID USERID, A.USERNAME, A.PASSWORD, A.EMAIL, A.ISVERIFIED, R.NAME ROLE 
		...
		--checking for existing username
			...
			ELSE
				...
				-- finally inserting into the owner table.
					INSERT INTO TBL_USERS(FIRST_NAME, MIDDLE_NAME, LAST_NAME, AUTHID, PHONE_NUMBER) VALUES (@FIRSTNAME, @MIDDLENAME, @LASTNAME, @AUTHID, @PHONENUMBER);
...
BEGIN
	IF @FLAG = 'R'
		BEGIN
			SELECT ID, METHOD PAYMENTMETHOD FROM TBL_PAYMENTMETHOD
		END
END
